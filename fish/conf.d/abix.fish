...
alias in='abix-shell pm install'
alias un='abix-shell pm remove'
alias up='abix-shell pm upgrade'
alias pl='abix-shell pm search installed'
alias pa='abix-shell pm search all'
alias g='git'
